...
(function($){ 	
	 ...
	 */
	var init = function( tb, options, tableWidth){	
		...
		t.g = []; t.c = []; t.w = tableWidth?tableWidth:t.width(); t.gc = t.prev(); t.f=t.opt.fixed;	//t.c and t.g are arrays of columns and grips respectively				
	...
	*/
	 ...
	 */
    $.fn.extend({  
        colResizable: function(options, tableWidth) {           
            var defaults = {
